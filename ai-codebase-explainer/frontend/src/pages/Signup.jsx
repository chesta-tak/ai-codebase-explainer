    ...
    <div className="relative isolate min-h-screen bg-dark-950 flex items-center justify-center px-4 overflow-hidden">
      ...
      >
        <Link to="/" className="flex items-center justify-center gap-2 mb-10">
          <div className="w-10 h-8 rounded-lg bg-warm-accent/20 border border-warm-accent/30 flex items-center justify-center">
            <GitBranch size={14} className="text-warm-accent" />
          </div>
        ...
        <div className="glass rounded-2xl p-8">
          ...
          <p className="text-gh-muted text-sm mb-7">Start understanding codebases in seconds</p>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-2 bg-gh-surface text-gh-muted">Or create account with email</span>
            </div>
          </div>
          ...
          <p className="text-center text-gh-muted text-sm mt-6">
            ...
            <Link to="/login" className="text-gh-accent hover:underline">Sign in</Link>
          </p>
        </div>
      </motion.div>
    </div>
